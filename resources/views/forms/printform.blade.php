        ...
        <div class="card-body" style="margin: 1rem;">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex gap-2" style="max-height: 90%;">
                    ...
                    <button type="button" class="btn btn-info rounded-5" style="font-size: medium;" id="tonerButton">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor"
                ...
                <div class="col" style="margin-left: 30px;">
                    ...
                    <div class="row justify-content-center text-center">
                        ...
                        <div class="modal-body d-none mt-3" id="dropdownForm">
                            ...
                            <label for="part2" class="form-label">Missing or Broken Parts / <span class="spanish-text">
